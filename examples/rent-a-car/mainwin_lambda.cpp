...
Mainwin::Mainwin() : _controller{Controller{}} {
    ...
    menuitem_new->signal_activate().connect([this] {_controller.execute_cmd(18);});
    filemenu->append(*menuitem_new);

    //         O P E N   R E N T A L   S I T E
    // Append Open to the File menu
    Gtk::MenuItem *menuitem_open = Gtk::manage(new Gtk::MenuItem("_Open", true));
    menuitem_open->signal_activate().connect([this]{_controller.execute_cmd(8);});
    filemenu->append(*menuitem_open);

    //         S A V E   R E N T A L   S I T E
    // Append Save to the File menu
    Gtk::MenuItem *menuitem_save = Gtk::manage(new Gtk::MenuItem("_Save", true));
    menuitem_save->signal_activate().connect([this]{_controller.execute_cmd(17);});
    filemenu->append(*menuitem_save);

    //         S A V E   A S   R E N T A L   S I T E
    // Append New to the File menu
    Gtk::MenuItem *menuitem_save_as = Gtk::manage(new Gtk::MenuItem("Save _As", true));
    menuitem_save_as->signal_activate().connect([this]{_controller.execute_cmd(7);});
    filemenu->append(*menuitem_save_as);

    //         Q U I T
    // Append Quit to the File menu
    Gtk::MenuItem *menuitem_quit = Gtk::manage(new Gtk::MenuItem("_Quit", true));
    menuitem_quit->signal_activate().connect([this]{hide();});
    ...
    menuitem_new_vehicle->signal_activate().connect([this]{
    ...
    menuitem_list_vehicles->signal_activate().connect([this]{_controller.execute_cmd(2);});
    ...
    menuitem_rent_vehicle->signal_activate().connect([this]{_controller.execute_cmd(3);});
    ...
    menuitem_return_vehicle->signal_activate().connect([this]{_controller.execute_cmd(4);});
    ...
    menuitem_new_renter->signal_activate().connect([this]{_controller.execute_cmd(5);});
    ...
    menuitem_list_renters->signal_activate().connect([this]{_controller.execute_cmd(6);});
    ...
    menuitem_help_->signal_activate().connect([this]{_controller.execute_cmd(9);});
    ...
    new_button->signal_clicked().connect([this]{_controller.execute_cmd(18);});
    ...
    open_button->signal_clicked().connect([this]{_controller.execute_cmd(8);});
    ...
    save_button->signal_clicked().connect([this]{_controller.execute_cmd(17);});
    ...
    new_vehicle_button->signal_clicked().connect([this]{
        int index_before = _controller.vehicles().size();
        _controller.execute_cmd(1);
        int index_after = _controller.vehicles().size();
        for (int i=index_before; i<index_after; ++i) add_row(i);});
    ...
    list_vehicles_button->signal_clicked().connect([this]{_controller.execute_cmd(2);});
    ...
    rent_vehicle->signal_clicked().connect([this]{_controller.execute_cmd(3);});
    ...
    return_vehicle->signal_clicked().connect([this]{_controller.execute_cmd(4);});
    ...
    new_renter_button->signal_clicked().connect([this]{_controller.execute_cmd(5);});
    ...
    list_renters_button->signal_clicked().connect([this]{_controller.execute_cmd(6);});
    ...
    quit_button->signal_clicked().connect([this]{hide();});
